...
class TrainCommands:
    def __init__(self):
        ...
        self.__cond = threading.Condition(self.__command_lock)
        
        self.__on_command: Callable[["TrainCommands"], None] | None = None

    # setter explícito
    def set_on_command(self, cb: Callable[["TrainCommands"], None] | None):
        """Registra função que será chamada quando um comando é emitido."""
        self.__on_command = cb
